...
var _user$project$Main$initSky = function (window) {
	return {
		width: 2000,
		height: _elm_lang$core$Basics$toFloat(window.height)
	};
};
var _user$project$Main$initDirection = 180;
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'WindowSize':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							camera: _user$project$Main$initCamera(_p1),
							sky: _user$project$Main$initSky(_p1)
						}),
			...
			default:
				...
				var newDirection = _elm_lang$core$Native_Utils.eq(arrows.x, -1) ? A2(
					_user$project$Main$rotate,
					model.direction,
					(0 - _elm_lang$core$Basics$pi) * _elm_lang$core$Time$inSeconds(_p2)) : (_elm_lang$core$Native_Utils.eq(arrows.x, 1) ? A2(
					_user$project$Main$rotate,
					model.direction,
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'width',
							_1: _user$project$Main$px(width * 1.5)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'height',
								_1: _user$project$Main$px(sky.height)
							},
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_0: {
										...
										_1: A2(
											_elm_lang$core$Basics_ops['++'],
											'url(\'',
											A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$skyImage, '\')'))
									},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'background-repeat-x', _1: 'repeat'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'background-repeat-y', _1: 'no-repeat'},
											_1: {
												ctor: '::',
												_0: {
													ctor: '_Tuple2',
													_0: 'background-position-x',
													_1: _user$project$Main$px(left)
												},
												_1: {
													ctor: '::',
